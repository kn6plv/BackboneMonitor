...
const Pages = {
    ...
    '/js/leaflet.js':     F({ path: `${__dirname}/../node_modules/leaflet/dist/leaflet.js`, type: 'text/javascript' }),
    '/css/leaflet.css':   F({ path: `${__dirname}/../node_modules/leaflet/dist/leaflet.css`, type: 'text/css' }),
};
